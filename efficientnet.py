...
def EfficientNet(width_coefficient,
    ...
    if input_tensor is None:
        ...
        if backend.backend() == 'tensorflow':
            ...
            tf.compat.v1.keras.backend.is_keras_tensor = backend.tf.compat.v1.keras.backend.is_keras_tensor
        if not tf.compat.v1.keras.backend.is_keras_tensor(input_tensor):
